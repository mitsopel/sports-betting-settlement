...
public class BetSettlementProducer {
    ...
    public void send(Bet bet, SportEventOutcome sportEventOutcome) {
        ...
        boolean won = bet.getEventWinnerId().equals(sportEventOutcome.eventWinnerId());
        BigDecimal payoutAmount = won ? bet.getBetAmount().multiply(BigDecimal.valueOf(2)) : BigDecimal.ZERO;
